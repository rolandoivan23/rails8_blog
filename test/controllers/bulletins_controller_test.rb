...
class BulletinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bulletin" do
    assert_difference("Bulletin.count") do
      post bulletins_url, params: { bulletin: { body: @bulletin.body, title: @bulletin.title } }
    end
  ...
  test "should update bulletin" do
    patch bulletin_url(@bulletin), params: { bulletin: { body: @bulletin.body, title: @bulletin.title } }
